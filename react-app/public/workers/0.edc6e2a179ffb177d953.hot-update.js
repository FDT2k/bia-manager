...
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
...
onmessage = function onmessage(e) {
  return Object(_parser__WEBPACK_IMPORTED_MODULE_3__["parse"])(e.data, progress, total_count, postMessage);
};
...
var parse = function parse(_ref, progress, total_count, callback) {
  ...
  data = data.map(function (line) {
    ...
    var _filterPropPresentIn = filterPropPresentIn(patient_keys, item),
    ...
    if (typeof carry.data[index_key] == "undefined") {
      var p = enlist(patient).reduce(remap(patient, mapping.patient), {});
    ...
    var remapped_mesure = enlist(mesure).reduce(remap(mesure, mapping.mesure, carry.data[index_key]), {});
