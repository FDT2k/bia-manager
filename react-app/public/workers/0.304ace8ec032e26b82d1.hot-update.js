...
var parse = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref, progress, total_count, callback) {
    var text, line_separator, mapping, separator, identifier, data, fields, total, report_every, count;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            text = _ref.text, line_separator = _ref.line_separator, mapping = _ref.mapping, separator = _ref.separator, identifier = _ref.identifier;
            console.log('parsing');
  ...
  return function parse(_x, _x2, _x3, _x4) {
