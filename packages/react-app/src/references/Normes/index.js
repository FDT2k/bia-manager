...
export const raw = [
    { type: 'ffmi', age_range: [18, 34], values: [16.8, 21.1], sex: 'M' },
    { type: 'ffmi', age_range: [35, 54], values: [17.2, 21.7], sex: 'M' },
    { type: 'ffmi', age_range: [55, 74], values: [16.6, 21.2], sex: 'M' },
    { type: 'ffmi', age_min: 75, values: [16.6, 21.2], sex: 'M' },
    { type: 'ffmi', age_range: [18 - 34], values: [13.8, 17.6], sex: 'F' },
    { type: 'ffmi', age_range: [35, 54], values: [14.4, 18.0], sex: 'F' },
    { type: 'ffmi', age_range: [55, 74], values: [14.1, 19.0], sex: 'F' },
    { type: 'ffmi', age_min: 75, values: [12.9, 18.7], sex: 'F' },
