    ...
    return (
        <LayoutFlex column>
            ...
            <LayoutFlex>
                ...
                {dataRef.current && <span><b>Données converties: </b><br/>{dataRef.current.countPatient} patients <br/> {dataRef.current.countMesure} mesures</span>}


            </LayoutFlex>

            <LayoutFlex justStretch>
                {dataRef.current && ! importing && !imported && <Button disabled={importing} onClick={addPatients}>Importer </Button>}
