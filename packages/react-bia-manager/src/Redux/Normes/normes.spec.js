...
const test_set = [  { type: 'ffmi', sex: 'M', age_range: [18, 34], values: [16.8, 21.1] },
...
test('hello world', () => {
    ...
    let mod = Module(identity, 'MESURE')
    ...
    let newState = mod.reducer(undefined, mod.actions.fetched(payload));
