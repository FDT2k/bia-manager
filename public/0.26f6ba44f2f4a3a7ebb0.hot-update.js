...
var transform = function transform(mapping) {
  return function (carry, item) {
    ...
    if (_mapped && Object(_karsegard_composite_js__WEBPACK_IMPORTED_MODULE_0__["is_type_string"])(_mapped)) {
      ...
      var name = _mapped.name,
          _transform = _mapped.transform;

      if (!Object(_karsegard_composite_js__WEBPACK_IMPORTED_MODULE_0__["is_type_function"])(_transform)) {
        _transform = eval(_transform);
      }

      carry[name] = _transform(carry[name], patient);
    }
...
var parse = function parse(_ref) {
  ...
  data = data.map(function (line) {
    ...
    if (typeof carry.data[index_key] == "undefined") {
      var p = Object(_karsegard_composite_js__WEBPACK_IMPORTED_MODULE_0__["enlist"])(patient).reduce(transform(mapping.patient), {});
    ...
    carry.data[index_key].mesures.push(Object(_karsegard_composite_js__WEBPACK_IMPORTED_MODULE_0__["enlist"])(mesure).reduce(transform(mapping.mesure), {}));
    carry.countMesure++;
    return carry;
  }, {
    data: {},
